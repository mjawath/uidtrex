...
{ 
    ...
    private ImagePanel m_imagePanela; 
    ...
    { 
        ...
        { 
            ...
            m_imagePanela = new ImagePanel(new ImageIcon("C:/Documents and Settings/Administrator/Desktop/MR SHAFEEK FAMILY.jpg").getImage(), zoomPercentage); 
            m_imagePanela.addMouseListener(this); 
            ...
            m_imageContainer.add(m_imagePanela); 
    ...
    public static void main(String[] args) {
        ImageZoomerFrame im=new ImageZoomerFrame(new ImageIcon("C:/Documents and Settings/Administrator/Desktop/MR SHAFEEK FAMILY.jpg").getImage(),-80d,"Image...");
    }
} 
